...
public class OriginationTools
{
    ...
    [McpServerTool(Name = "list_applications"), Description("List every loan application known to the Origination service.")]
    public Task<ApiResult> ListApplications() =>
        _client.GetAsync(LoanPlatformService.Origination, "api/applications");

    [McpServerTool(Name = "get_application"), Description("Get full details of one application by its ApplicationId (e.g. 'APP-1A2B3C4D').")]
    ...
    [McpServerTool(Name = "get_application_status"), Description(
    ...
    [McpServerTool(Name = "update_application"), Description(
    ...
    [McpServerTool(Name = "get_application_documents"), Description("List documents that have been recorded against an application.")]
    ...
    [McpServerTool(Name = "record_document_upload"), Description(
    ...
    [McpServerTool(Name = "run_credit_check"), Description(
    ...
    [McpServerTool(Name = "submit_application"), Description(
