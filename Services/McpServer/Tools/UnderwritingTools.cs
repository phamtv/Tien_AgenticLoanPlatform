...
public class UnderwritingTools
{
    ...
    [McpServerTool(Name = "get_decision"), Description(
    ...
    [McpServerTool(Name = "get_risk_score"), Description(
    ...
    [McpServerTool(Name = "get_copilot_summary"), Description(
    ...
    [McpServerTool(Name = "evaluate_application"), Description(
